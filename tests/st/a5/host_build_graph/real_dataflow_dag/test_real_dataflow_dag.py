...
# -----------------------------------------------------------------------------------------------------------
"""Real AIV dataflow DAGs for A5 host_build_graph."""
...
class TestHbgRealChainDag(SceneTestCase):
    RTOL = 1e-5
    ATOL = 1e-5
...
@scene_test(level=2, runtime="host_build_graph")
class TestHbgRealDiamondDag(SceneTestCase):
    RTOL = 1e-5
    ATOL = 1e-5
...
@scene_test(level=2, runtime="host_build_graph")
class TestHbgRealMultiRootDag(SceneTestCase):
    RTOL = 1e-5
    ATOL = 1e-5
