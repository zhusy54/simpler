...
constexpr int32_t kSingleAivFuncId = 1;
constexpr int32_t kAiv0FuncId = 2;
constexpr int32_t kAiv1FuncId = 3;
...
__attribute__((visibility("default"))) void aicpu_orchestration_entry(const ChipTaskArgs &args) {
    ...
    const MixedKernels aiv{INVALID_KERNEL_ID, kSingleAivFuncId, INVALID_KERNEL_ID};
