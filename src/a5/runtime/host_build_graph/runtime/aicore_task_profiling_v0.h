...
inline __host__ __aicore__ void aicore_task_profiling_commit_resolve_v0(
    __gm__ ChipSwimlaneAicoreTaskRecord *record, __gm__ AicoreWorkerContextV0 *worker, uint64_t task_id,
    ...
    chip_swimlane_aicore_commit_task_record(
        record, task_id,
        CHIP_SWIMLANE_AICORE_RESOLVE_RECORD_TAG |
            (static_cast<uint32_t>(task_id) & CHIP_SWIMLANE_AICORE_RECORD_ID_MASK),
